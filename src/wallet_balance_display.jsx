...
function Wallet_balance_display() {
    ...
    return (
            ...
            <div className="Wallet_display" >
                ...
                <button onClick={() => setIsOpen(true)} style={{ width: "167.65px", height: "38px", borderRadius: "15px", fontFamily: "Ubuntu", fontWeight: 700, fontSize: "16px", color: "white", backgroundColor: "#B5DC52", border: "none " }}>+ Add Income</button>
